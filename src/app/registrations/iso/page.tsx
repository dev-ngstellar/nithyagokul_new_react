...
import { CheckCircle2, ShieldCheck, Clock, FileCheck, Check, Award } from "lucide-react";
...
export async function generateMetadata() {
  const registration = registrationsData.find((r) => r.slug === "iso");
  if (!registration) return {};
  return {
    title: `ISO Certification Services | Nithya Gokul Associates`,
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            <FadeIn className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-xs font-bold tracking-widest text-gold uppercase shadow-[0_0_20px_rgba(212,175,55,0.15)]">
                ...
                <span>GLOBAL QUALITY CERTIFICATION</span>
              </div>

              <h1 className="font-serif text-4xl md:text-[52px] lg:text-[60px] font-bold leading-[1.15] text-white">
                ISO Certification <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-yellow-200">Services</span>
              </h1>
          ...
          <SlideUp delay={0.4} className="lg:col-span-5 relative">
            ...
            <div className="bg-[rgba(255,255,255,0.92)] backdrop-blur-xl rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] border border-white/50 overflow-hidden relative">
              <div className="p-8 pb-2 text-center">
                ...
                <h3 className="font-serif text-[22px] font-bold text-navy mb-2">Apply For ISO Certification</h3>
                <p className="text-sm text-slate-600">Get certified by accredited ISO auditing experts.</p>
              </div>

              <LeadForm
                buttonText="Get ISO Certified"
                isRadio={true}
                lockedService="ISO Certification"
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp className="space-y-6">
            <SectionHeading
              align="left"
              badge="Applicability"
              title="Who Needs ISO Certification?"
              subtitle="ISO certifications empower businesses across all industries to improve processes and win global trust."
            />
            ...
            <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/50">
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm font-medium text-navy">
                  Enhance your brand value, meet tender requirements, and establish global quality management standards.
                </p>
              </div>
            </div>
          </SlideUp>
      ...
      <section className="py-[70px] md:py-[90px] lg:py-[120px] bg-white">
        <div className="max-w-[1280px] mx-auto px-6">
          <SectionHeading
            ...
            subtitle="Strengthen customer confidence, quality management, and international market positioning."
          />
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp>
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Keep these basic documents ready. Our ISO consultants will handle process mapping and internal audit documentation.
            </p>
            <div className="space-y-4">
