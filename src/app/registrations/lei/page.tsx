...
import { CheckCircle2, ShieldCheck, Clock, FileCheck, Check, Globe } from "lucide-react";
...
export async function generateMetadata() {
  const registration = registrationsData.find((r) => r.slug === "lei");
  if (!registration) return {};
  return {
    title: `Legal Entity Identifier (LEI) Code | Nithya Gokul Associates`,
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            <FadeIn className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-xs font-bold tracking-widest text-gold uppercase shadow-[0_0_20px_rgba(212,175,55,0.15)]">
                ...
                <span>GLOBAL FINANCIAL IDENTIFIER</span>
              </div>

              <h1 className="font-serif text-4xl md:text-[52px] lg:text-[60px] font-bold leading-[1.15] text-white">
                Legal Entity Identifier <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-yellow-200">(LEI Code)</span>
              </h1>
            ...
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4">
              {[
                "20-Digit Unique LEI",
                "RBI Mandate Compliant",
                "Credit Limit Support",
                "GLEIF Global Database",
            ...
            <div className="bg-[rgba(255,255,255,0.92)] backdrop-blur-xl rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] border border-white/50 overflow-hidden relative">
              <div className="p-8 pb-2 text-center">
                <div className="w-16 h-16 mx-auto bg-blue/10 rounded-full p-2 shadow-sm border border-slate-100 mb-4 flex items-center justify-center">
                  <Globe className="w-8 h-8 text-blue" />
                </div>
                <h3 className="font-serif text-[22px] font-bold text-navy mb-2">Apply For LEI Code</h3>
                <p className="text-sm text-slate-600">Quick LEI registration for RBI banking compliance.</p>
              </div>

              <LeadForm
                buttonText="Start LEI Registration"
                isRadio={true}
                lockedService="Legal Entity Identifier (LEI)"
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp className="space-y-6">
            <SectionHeading
              align="left"
              badge="Applicability"
              title="Who Needs LEI Registration?"
              subtitle="Mandatory under RBI guidelines for corporate borrowers and large financial transactions."
            />
          ...
          <SlideUp delay={0.2} className="relative h-full min-h-[400px] lg:min-h-full rounded-3xl overflow-hidden border border-slate-200 shadow-xl group">
            ...
            <Image
              src="/hero-banner/lei-finance.webp"
              alt="LEI Financial Compliance"
              fill
            ...
            <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/50">
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm font-medium text-navy">
                  Establish global financial transparency and fulfill mandatory RBI credit guidelines seamlessly.
                </p>
              </div>
            </div>
          </SlideUp>
      ...
      <section className="py-[70px] md:py-[90px] lg:py-[120px] bg-white">
        <div className="max-w-[1280px] mx-auto px-6">
          <SectionHeading
            align="center"
            badge="Advantages"
            title="Benefits of LEI Code"
            subtitle="Ensure regulatory compliance and enhance corporate credibility in financial networks."
          />
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp>
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Keep entity proof, PAN details, and board authorization ready for LEI registration.
            </p>
            <div className="space-y-4">
