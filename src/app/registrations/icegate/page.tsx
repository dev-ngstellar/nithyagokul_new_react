...
import { CheckCircle2, ShieldCheck, Clock, FileCheck, Check, Ship } from "lucide-react";
...
export async function generateMetadata() {
  const registration = registrationsData.find((r) => r.slug === "icegate");
  if (!registration) return {};
  return {
    title: `ICEGATE Registration Services | Nithya Gokul Associates`,
...
export default function ICEGATEPage() {
  ...
  return (
    <div className="block w-full bg-white">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            <FadeIn className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-xs font-bold tracking-widest text-gold uppercase shadow-[0_0_20px_rgba(212,175,55,0.15)]">
                ...
                <span>INDIAN CUSTOMS EDI GATEWAY</span>
              </div>
            ...
            <FadeIn delay={0.2}>
              <div className="inline-flex items-center gap-5 p-4 pr-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-gold/30 shadow-[0_0_30px_rgba(212,175,55,0.1)] relative group hover:border-gold/50 transition-colors duration-500">
                <div className="w-16 h-16 bg-gold/10 rounded-xl flex items-center justify-center shrink-0 border border-gold/20">
                  <Ship className="w-9 h-9 text-gold" />
                </div>
                <div>
                  ...
                  <p className="text-sm text-gold font-medium flex items-center gap-1.5">
                    <CheckCircle2 className="w-4 h-4" /> Port Linking &amp; Custom Duty E-Filing
                  </p>
                </div>
              </div>
            </FadeIn>
            ...
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4">
              {[
                "Customs Portal Setup",
                "Class-3 DSC Linking",
                "AD Code Registration",
                "Bill of Entry E-Filing",
                "Shipping Bill Access",
                "Port Approval Assistance"
              ].map((point, idx) => (
                <StaggerItem key={idx}>
          ...
          <SlideUp delay={0.4} className="lg:col-span-5 relative">
            ...
            <div className="bg-[rgba(255,255,255,0.92)] backdrop-blur-xl rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] border border-white/50 overflow-hidden relative">
              <div className="p-8 pb-2 text-center">
                ...
                <h3 className="font-serif text-[22px] font-bold text-navy mb-2">Apply For ICEGATE Registration</h3>
                <p className="text-sm text-slate-600">Fast customs EDI registration by compliance experts.</p>
              </div>

              <LeadForm
                buttonText="Start ICEGATE Registration"
                isRadio={true}
                lockedService="ICEGATE Registration"
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp className="space-y-6">
            <SectionHeading
              align="left"
              badge="Eligibility"
              title="Who Needs ICEGATE Registration?"
              subtitle="ICEGATE registration is mandatory for businesses participating in customs clearance and international trade."
            />
          ...
          <SlideUp delay={0.2} className="relative h-full min-h-[400px] lg:min-h-full rounded-3xl overflow-hidden border border-slate-200 shadow-xl group">
            ...
            <Image
              src="/hero-banner/icegate-customs.webp"
              alt="ICEGATE Customs Clearance"
              fill
            ...
            <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/50">
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm font-medium text-navy">
                  Seamlessly interface with Indian Customs ports, file import/export declarations, and track duty refunds.
                </p>
              </div>
            </div>
          </SlideUp>
      ...
      {/* 3. Benefits Of ICEGATE */}
      <section className="py-[70px] md:py-[90px] lg:py-[120px] bg-white">
        <div className="max-w-[1280px] mx-auto px-6">
          <SectionHeading
            align="center"
            badge="Advantages"
            title="Benefits of ICEGATE Registration"
            subtitle="Accelerate your customs clearance and global logistics workflows."
          />
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp>
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Ensure you have your IEC certificate and Class-3 DSC ready for port registration.
            </p>
            <div className="space-y-4">
