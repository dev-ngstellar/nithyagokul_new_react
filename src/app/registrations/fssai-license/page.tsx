...
import { CheckCircle2, ShieldCheck, Clock, FileCheck, Check, ChevronRight } from "lucide-react";
...
export async function generateMetadata() {
  const registration = registrationsData.find((r) => r.slug === "fssai");
  if (!registration) return {};
  return {
    title: `Premium FSSAI License Registration | Nithya Gokul Associates`,
        ...
        <div className="max-w-[1280px] mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            <FadeIn className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-xs font-bold tracking-widest text-gold uppercase shadow-[0_0_20px_rgba(212,175,55,0.15)]">
                ...
                <span>FSSAI REGISTRATION SERVICES</span>
              </div>

              <h1 className="font-serif text-4xl md:text-[52px] lg:text-[60px] font-bold leading-[1.15] text-white">
                Get Your FSSAI <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-yellow-200">Food License</span> <br />
                <span className="text-3xl md:text-[40px] lg:text-[48px] text-white/90">Fast, Compliant & Hassle-Free</span>
              </h1>

              <p className="text-[16px] md:text-[18px] text-slate-300 max-w-2xl leading-[1.8] font-light">
                Every food business operator involved in manufacturing, processing, storage, distribution, transportation, or sale of food products requires FSSAI registration under the Food Safety and Standards Act.
                <br /><br />
                Our team assists with documentation, filing, approval, and renewal support.
              </p>
            </FadeIn>

            {/* Premium FSSAI Visual / Floating Badge */}
            <FadeIn delay={0.2}>
          ...
          <SlideUp delay={0.4} className="lg:col-span-5 relative">
            ...
            <div className="bg-[rgba(255,255,255,0.92)] backdrop-blur-xl rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] border border-white/50 overflow-hidden relative">
              ...
              {/* LeadForm */}
              <LeadForm
                buttonText="Start FSSAI Registration"
                isRadio={true}
                lockedService="Food License (FSSAI)"
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp className="space-y-6">
            <SectionHeading
              align="left"
              badge="Eligibility"
              title="Who Needs an FSSAI License?"
              subtitle="The FSSAI license is categorized based on business capacity and annual turnover."
            />
            ...
            <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/50">
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm font-medium text-navy">
                  Whether you&apos;re a petty food business or a large-scale manufacturer, we have you covered.
                </p>
              </div>
            </div>
          </SlideUp>
      ...
      <section className="py-[70px] md:py-[90px] lg:py-[120px] bg-white">
        <div className="max-w-[1280px] mx-auto px-6">
          <SectionHeading
            align="center"
            badge="Advantages"
            title="Benefits of having FSSAI License"
            subtitle="Secure your business future with a recognized legal permit."
          />
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <SlideUp>
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Keep these documents handy. Our experts will assist you in preparing the FSMS plan and specific layout blueprints based on your food category.
            </p>
            <div className="space-y-4">
          ...
          {/* 5. Registration Process Timeline */}
          <SlideUp delay={0.2}>
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl text-navy">
              ...
              <div className="mt-10 p-5 rounded-2xl bg-blue/5 border border-blue/10 flex items-center justify-center gap-2">
                <p className="text-sm font-bold text-navy text-center">
                  Estimated Timeline: <span className="text-blue">{registration.timeline}</span>
                </p>
              </div>
            </div>
          </SlideUp>
